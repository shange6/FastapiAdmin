    ...
    >
      ...
      <template v-if="dialogVisible.type === 'detail'">
        <el-descriptions :column="4" border>
          <el-descriptions-item label="项目编码" :span="4" :label-width="120">
            {{ detailFormData.code }}
          </el-descriptions-item>
          <el-descriptions-item label="项目名称" :span="4" :label-width="120">
            {{ detailFormData.name }}
          </el-descriptions-item>
          <el-descriptions-item label="项目编号" :span="4" :label-width="120">
            {{ detailFormData.no }}
          </el-descriptions-item>
        </el-descriptions>
      </template>
